document.body.onload = function () {
  ...
  var css = ".draggo{cursor: move;display: inline-block;} .text{display: inline-block; cursor: move;} .text:focus{cursor: auto;} .text-wrapper{width: 100%;position: relative;} .wrap{position: absolute;margin: auto;top: 0;bottom: 0;left: 0;right: 0;}';";
  ...
  // Select all elements with the 'draggo' class and stores them in the 'elements' variable
  var elements = document.querySelectorAll(".draggo");
  ...
  // Adds event listeners to every element that has the draggo class
