        ...
        function changeStages() {
            if (currentPosition == maxElements) {
                ...
                listElNodesObj[maxElements - 1].addEventListener('transitionend', function () {
                    ...
                    document.querySelector('.secret').classList.add('active');
                    document.querySelector('.secret-msg').classList.remove('hidden');
                    document.querySelector('.secret-msg').classList.add('active');
                    $(".secret-msg").fadeOut(500);
                    $(".secret-msg").fadeIn(500);
